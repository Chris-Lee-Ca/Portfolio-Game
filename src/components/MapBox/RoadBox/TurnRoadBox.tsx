        ...
        <>
            <Container sx={{ transform: getTransformDegreee(facing) }}>
                <RowContainer>
                    <Barrier />
                    <Road
                        sx={{ borderLeft: CustomStyle.border.mapBorder, borderRight: CustomStyle.border.mapBorder }}
                    />
                    <Barrier />
                </RowContainer>
                <RowContainer>
                    <Road
                        sx={{ borderTop: CustomStyle.border.mapBorder, borderBottom: CustomStyle.border.mapBorder }}
                    />
                    <Road
                        sx={{ borderBottom: CustomStyle.border.mapBorder, borderRight: CustomStyle.border.mapBorder }}
                    />
                    <Barrier />
                </RowContainer>
                <RowContainer>
