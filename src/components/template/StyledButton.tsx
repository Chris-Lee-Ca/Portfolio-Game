...
const StyledButton = ({ children, onClick, type, form }: styledButtonProps) => {
    return (
        <_Button form={form} type={type} onClick={onClick}>
            {children}
        </_Button>
    );
};
        ...
        <>
            {type === "direction" ? (
                <KeyBoardButton
                    ...
                    style={{
                        ...style,
                        backgroundColor: isChangeColor ? CustomStyle.colors.mainBlue : CustomStyle.colors.primary,
                    }}
                >
                    {children}
                </KeyBoardButton>
                ...
                <ActionButton
                    ...
                    style={{
                        ...style,
                        backgroundColor: isChangeColor ? CustomStyle.colors.mainBlue : CustomStyle.colors.mainGreen,
                    }}
                >
                    {children}
                </ActionButton>
