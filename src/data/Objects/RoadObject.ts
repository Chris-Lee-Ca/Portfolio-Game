...
export const startingPoint: roadBoxDesignInterface = {
    ...N_DeadEndRoute,
    isStarting: true,
    forceTriggerFunction: (dialogState: DialogStateInterface, setDialogState: Dispatch<SetStateAction<DialogStateInterface>>) => {
...
export const introRoute: roadBoxDesignInterface = {
    ...
    canIntactive: true,
    onTopItemType: 'Board',
    interactiveFunction: (gameInfoState: GameInfoStateInterface, setGameInfoState: Dispatch<SetStateAction<GameInfoStateInterface>>) => {
