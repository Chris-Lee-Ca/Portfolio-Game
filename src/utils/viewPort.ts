...
export const getViewPort = ({
    ...
    mapBoxHeight,
    mapDesign,
}: GetViewPortInterface): RenderRangeInterface => {
...
export const getGameMapSize = ({ windowWidth, windowHeight, mapBoxWidth, mapBoxHeight }: GetGameMapSizeInterface) => {
    const { canFitBoxWidth, canFitBoxHeight } = getCanFitGameBox({
        windowWidth,
        windowHeight,
        mapBoxWidth,
        mapBoxHeight,
...
export const getGameMapContainerOffset = ({
    currentPosition,
    gameMapWidth,
    gameMapHeight,
    mapBoxWidth,
    mapBoxHeight,
    viewPort,
}: GetGameMapContainerOffsetInterface) => {
    const { canFitBoxWidth, canFitBoxHeight } = getCanFitGameBox({
        windowWidth: gameMapWidth,
        windowHeight: gameMapHeight,
        mapBoxWidth,
        mapBoxHeight,
    });
